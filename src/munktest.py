...
class ProtoActivity(Activity):
    ...
    def on_create(self, config):
        ...
        walls = [pymunk.Segment(space.static_body, (10, 10), (10, 740), 3),
                pymunk.Segment(space.static_body, (10, 10), (740, 10), 3),
                pymunk.Segment(space.static_body, (740, 740), (10, 740), 3),
                pymunk.Segment(space.static_body, (740, 740), (740, 10), 3)]
        for w in walls:
            w.elasticity = .2
            w.friction = 2.0
            w.color = (255,0,0)
        ...
        #self.spinner = self.make_spinner( (250,80))
        #self.spinner = self.make_spinner( (400,80))
        ...
        for i in range(10):
            ...
            body.position = (100, 10+i*size)
            shape = pymunk.Poly(body, ((0,0),(size,0),(size,size),(0,size)))
            body.shape = shape
            shape.color = (0,255,0)
    ...
    def draw(self, screen):
        ...
        pos = pygame.mouse.get_pos()
        #pygame.draw.rect(screen, (255,255,0), (pos[0], pos[1], self.charge/MAXCHARGE*100, 15))
